...
We can draw a picture of a distribution by letting the height of bars represent
...
$$ \lambda = \frac{5 \text{ meows}}{10 \text{ minutes}} = 5 \frac{ \text{
meows}}{\text{ 10 minutes}} $$

So using the Poisson equation

$$ P(\text{Cat meows zero times in ten minutes}) = e^{-5} \frac{5^0}{0!} = 0.007
$$
\end{frame}
%
...
$$
\lambda = \frac{5 \text{ meows}}{10 \text{ minutes}} = 30 \frac{ \text{
meows}}{\text{ 60 minutes}} = 30 \frac{ \text{
meows}}{\text{ hour}}
$$
...
least two times in the next ten minutes?
