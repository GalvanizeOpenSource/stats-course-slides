...
If I have a coin which is \textbf{known} to land on heads exactly half of the time, it is a problem in \textbf{probability} to determine how often the coin will never land on heads over ten consecutive flips.
...
\textbf{Day 2 (Wednesday):} Basics of Statistics.
