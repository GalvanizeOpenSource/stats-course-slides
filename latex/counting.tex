...
The number of \textbf{ordered} selections \textbf{of k objects} without replacement \textbf{from a population of n objects} is called the \textbf{number of permutations of k objects taken from n}.
...
The number of \text{unordered} selections \textbf{of k objects} without replacement \textbf{from a population of n objects} is called the \textbf{number of combinations of k objects taken from n}.
...
How many hands are there that contain a three-of-kind that are not full houses and also not four of a kind?
